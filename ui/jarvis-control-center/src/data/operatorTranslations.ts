const OPERATOR_TRANSLATIONS = {
  ...
  evidence_auto_loop: {
    ...
    action: 'Keine Aktion für Frank. Hermes plant weitere Evidenzläufe.',
    severity: 'good',
    whatHermesDoes: 'plant weitere Evidenz- und Validierungsaufgaben',
    franksAction: 'Nein',
  },
  evidence_auto_loop_disabled: {
    title: 'Evidenz-Auto-Loop pausiert',
    meaning: 'Hermes führt den Evidenz-Auto-Loop aktuell nicht automatisch aus.',
    action: 'Keine Aktion erforderlich.',
    severity: 'hint',
    whatHermesDoes: 'wartet auf Aktivierung',
    franksAction: 'Nein',
  },
  evidence_auto_loop_waiting_for_window: {
    title: 'Wartet auf Lern- oder Nightly-Fenster',
    meaning: 'Hermes darf den Evidenz-Auto-Loop erst im erlaubten Fenster starten.',
    action: 'Keine Aktion erforderlich.',
    severity: 'hint',
    whatHermesDoes: 'wartet auf das erlaubte Zeitfenster',
    franksAction: 'Nein',
  },
  evidence_auto_loop_waiting_for_learning_window: {
    title: 'Wartet auf Lernfenster',
    meaning: 'Hermes darf den Evidenz-Auto-Loop nur im Lernfenster starten.',
    action: 'Keine Aktion erforderlich.',
    severity: 'hint',
    whatHermesDoes: 'wartet auf das Lernfenster',
    franksAction: 'Nein',
  },
