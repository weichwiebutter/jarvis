...
function reportFixtureRaw(key) {
  switch (key) {
    ...
    case 'mutationValidationExecution':
      return {
        report_version: 'mutation_validation_execution_v1',
        updated_at_utc: runtimeMasterStatusMock.updated_at_utc,
        report_role: 'last_run',
        queue_items_loaded: 8,
        ready_jobs_found: 8,
        jobs_attempted: 1,
        jobs_executed: 1,
        jobs_skipped: 7,
        status_distribution: ['attempted:1', 'executed:1', 'skipped:7'],
        warnings: [],
        operator_summary: '1 Mutation-Job geprüft. 1/1 ausgeführt. Ergebnis: improved. Trades=50. Frank nötig: nein. Keine Broker-Aktionen.',
        safety_summary: 'no_auto_trading=true, human_review_required=true, broker_orders_enabled=false, live_trading_enabled=false, research_only=true',
        frank_required: false,
        no_trading_execution: true,
        no_broker_action: true,
        ...
        latest_success_available: true,
        latest_success_path: '/mnt/d/HermesData/reports/strategy_backtest_execution/strategy_backtest_latest_success.json',
        result_path: '/mnt/d/HermesData/reports/mutation_validation_execution/results/mutation_validation_result_mutation_validation_fgmp_backtest_job_validation_plan_trading_research_mean_reversion_rejection_bollinger_band_width_session_filter_sharpen.json',
        history_path: '/mnt/d/HermesData/reports/mutation_validation_execution/history/mutation_validation_run_history.jsonl',
        selected_job: {
          validation_job_id: 'mutation_validation_fgmp_backtest_job_validation_plan_trading_research_mean_reversion_rejection_bollinger_band_width_session_filter_sharpen',
          mutation_id: 'mutation_plan_trading_research_mean_reversion_rejection_bollinger_band_width_session_filter_sharpen',
          strategy_pattern: 'Mean Reversion Rejection',
          asset: 'XAUUSD',
          timeframe: 'M5',
          mutation_type: 'session_filter_sharpen',
          required_dataset: 'historical_data:XAUUSD:M5',
          backtest_required: true,
          oos_required: true,
          walk_forward_required: true,
          monte_carlo_required: true,
          cost_spread_model_required: true,
          max_runs: 50,
        ...
        execution: {
          execution_id: 'mutation_validation_execution_20260618_0001',
          mutation_validation_job_id: 'mutation_validation_fgmp_backtest_job_validation_plan_trading_research_mean_reversion_rejection_bollinger_band_width_session_filter_sharpen',
          mutation_id: 'mutation_plan_trading_research_mean_reversion_rejection_bollinger_band_width_session_filter_sharpen',
          strategy_pattern: 'Mean Reversion Rejection',
          asset: 'XAUUSD',
          timeframe: 'M5',
          ...
          trades_simulated: 50,
          win_rate: 0.66,
          profit_factor: 1.4734,
          max_drawdown: -4.8743,
          expectancy: 0.1702,
          r_multiple_avg: 0.1702,
        ...
        comparison: {
          baseline_backtest_job_id: 'backtest_job_validation_plan_trading_research_mean_reversion_rejection_bollinger_band_width',
          baseline_trades_simulated: 50,
          baseline_win_rate: 0.36,
          baseline_profit_factor: 0.7186,
          baseline_max_drawdown: -11.158,
          baseline_expectancy: -0.1278,
          baseline_quality_class: 'low_confidence',
          baseline_certification_ready: false,
          mutation_trades_simulated: 50,
          mutation_win_rate: 0.66,
          mutation_profit_factor: 1.4734,
          mutation_max_drawdown: -4.8743,
          mutation_expectancy: 0.1702,
          mutation_quality_class: 'low_confidence',
          mutation_certification_ready: false,
          win_rate_delta: 0.3,
          profit_factor_delta: 0.7548,
          max_drawdown_delta: 6.2837,
          expectancy_delta: 0.298,
          outcome: 'improved',
        },
      };
    case 'mutationAttributionAnalysis':
      return {
        report_version: 'mutation_attribution_analysis_v1',
        updated_at_utc: runtimeMasterStatusMock.updated_at_utc,
        latest_success_path: '/mnt/d/HermesData/reports/strategy_backtest_execution/strategy_backtest_latest_success.json',
        mutation_execution_path: '/mnt/d/HermesData/reports/mutation_validation_execution/mutation_validation_execution.json',
        failure_learning_path: '/mnt/d/HermesData/reports/strategy_backtest_failure_learning/strategy_backtest_failure_learning.json',
        mutation_candidate_queue_path: '/mnt/d/HermesData/reports/mutation_candidate_queue/mutation_candidate_queue.json',
        mutation_validation_jobs_path: '/mnt/d/HermesData/reports/mutation_validation_jobs/mutation_validation_jobs.json',
        mutation_validation_execution_role: 'last_run',
        baseline_strategy_pattern: 'Mean Reversion Rejection',
        baseline_asset: 'XAUUSD',
        baseline_timeframe: 'M5',
        baseline_mutation_type: 'session_filter_sharpen',
        baseline_win_rate: 0.36,
        baseline_profit_factor: 0.7186,
        baseline_max_drawdown: -11.158,
        baseline_expectancy: -0.1278,
        ...
        max_drawdown_delta: 6.2837,
        expectancy_delta: 0.298,
        result_class: 'improvement_likely_caused_by_session_filter',
        cause: 'improvement_likely_caused_by_session_filter',
        learning_hypothesis: 'Die Strategie funktioniert deutlich besser, wenn bestimmte Handelssessions ausgeschlossen werden.',
        supporting_signals: [
          'mutation_type:session_filter_sharpen',
          'profit_factor_delta:0.7548',
          'expectancy_delta:0.298',
          'win_rate_delta:0.3',
          'max_drawdown_delta:6.2837',
          'learning_decision:improved',
          'mutation_queue_size:8',
        ],
        warnings: [],
        frank_required: false,
    ...
    case 'strategyBacktestEvidenceGate':
      return {
        report_version: 'strategy_backtest_evidence_gate_v1',
        updated_at_utc: runtimeMasterStatusMock.updated_at_utc,
        audited_backtests: 1,
        passed_research_gate_count: 0,
        passed_oos_gate_count: 0,
        passed_certification_gate_count: 0,
        ...
        warnings: [],
        operator_summary: 'Mean Reversion Rejection · XAUUSD M5\n\nTechnischer Backtest: erfolgreich\n\nHistorie:\n42 Tage\n\nTrades:\n3\n\nErgebnis:\ninsufficient sample\n\nGrund:\nboth\n\nEmpfehlung:\nHistorischen Zeitraum und Testumfang erweitern.\n\nFrank nötig:\nnein',
        frank_required: false,
        report_path: '/mnt/d/HermesData/reports/strategy_backtest_quality/strategy_backtest_evidence_gate.json',
        markdown_path: '/mnt/d/HermesData/reports/strategy_backtest_quality/strategy_backtest_evidence_gate.md',
        entries: [
          {
            backtest_job_id: 'backtest_job_validation_plan_trading_research_mean_reversion_rejection_bollinger_band_width',
            strategy_pattern: 'Mean Reversion Rejection',
            asset: 'XAUUSD',
            timeframe: 'M5',
            historical_period_days: 42,
            historical_bars: 1200,
            trading_days: 42,
            trades_simulated: 3,
            sample_classification: 'insufficient_sample',
            passed_research_gate: false,
            passed_oos_gate: false,
            passed_certification_gate: false,
            root_cause: 'both',
            warnings: ['insufficient_sample'],
          },
        ],
    ...
    case 'autonomousResearchLoop':
      return {
        report_version: 'autonomous_research_loop_v1',
        updated_at_utc: runtimeMasterStatusMock.updated_at_utc,
        status: 'waiting_for_allowed_time_window',
        status_label: 'wartet auf erlaubtes Zeitfenster',
        in_work_window: false,
        in_learning_window: false,
        evidence_auto_loop_enabled: true,
        research_loop_enabled: true,
        safety_eligible: false,
        safety_status: 'no_auto_trading=true, broker_orders_enabled=false, live_trading_enabled=false, research_only=true, evidence_auto_loop_enabled=true, in_work_window=false, learning_window=false',
        frank_required: false,
        step_type: 'wait',
        step_status: 'waiting_for_allowed_time_window',
        step_result: 'waiting',
        selected_job_id: null,
        selected_job_mutation_type: null,
        why_selected: 'Zeitsteuerung oder Safety-Fenster nicht aktiv.',
        next_planned_step: 'Warten auf erlaubtes Arbeits- oder Lernfenster.',
        mutation_execution: null,
        mutation_planner: reportFixtureRaw('strategyMutationValidationPlanner'),
        mutation_queue: reportFixtureRaw('mutationCandidateQueue'),
        failure_learning: reportFixtureRaw('strategyBacktestFailureLearning'),
        quality_audit: reportFixtureRaw('strategyBacktestQualityAudit'),
        evidence_auto_loop_state: reportFixtureRaw('evidenceAutoLoop'),
        time_control: reportFixtureRaw('timeControl'),
        warnings: ['outside_allowed_window'],
        operator_summary: 'Hermes arbeitet selbstständig an der Research-Queue. Letzter Schritt: wartet auf Zeitfenster. Frank nötig: nein.',
        no_trading_execution: true,
        no_broker_action: true,
        no_auto_trading: true,
        human_review_required: true,
...
export async function loadOperatorDashboard() {
  ...
  rawReports.autonomousResearchLoop = reportFixtureRaw('autonomousResearchLoop');
