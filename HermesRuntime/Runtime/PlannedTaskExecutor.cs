        ...
        catch (Exception ex) when (ex is IOException or JsonException or InvalidOperationException)
        {
            var warning = BuildResult(
                new PlannedTask(
                    ...
                    QueueType: "review",
                    Priority: new PriorityScore(0, 0, 0, 0, 0, 0, 0, 0, 0),
                    Reason: "Refresh Cognitive Core outputs after controlled task execution.",
                    ExpectedOutcome: "cognitive_outputs_refreshed",
                    SourceRefs: [],
                    CreatedAtUtc: DateTimeOffset.UtcNow,
                    Status: "planned",
                    SupportingGoalId: "improve_cognitive_memory_quality",
                    GoalReason: "Post-execution refresh should preserve Cognitive Core memory quality.",
                    ExpectedGoalDelta: 0,
                    NoTradingExecution: true,
                    HumanReviewRequired: true),
                "failed",
