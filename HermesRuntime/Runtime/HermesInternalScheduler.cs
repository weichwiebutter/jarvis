...
public sealed class HermesInternalScheduler
{
    ...
    private static bool IsAllowed(ScheduledJobDefinition job)
    {
        ...
        return job.JobType switch
        {
            ...
            "scan_software_domain" => job.Command.Equals("scan-software-domain", StringComparison.OrdinalIgnoreCase),
            "scan_documentation_domain" => job.Command.Equals("scan-documentation-domain", StringComparison.OrdinalIgnoreCase),
            "scan_process_domain" => job.Command.Equals("scan-process-domain", StringComparison.OrdinalIgnoreCase),
            "scan_research_domain" => job.Command.Equals("scan-research-domain", StringComparison.OrdinalIgnoreCase),
            ...
            "generate_domain_insights" => job.Command.Equals("domain-insights", StringComparison.OrdinalIgnoreCase),
